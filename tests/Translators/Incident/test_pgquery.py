...
from Translators.Incident import pgquery
import sqlalchemy
import os

# test that init_tcp_connection_engine is calling sqlalchemy.create_engine with expected arguments
@patch('Translators.Incident.pgquery.db_config', new={'pool_size': 5, 'max_overflow': 2, 'pool_timeout': 30, 'pool_recycle': 1800})
...
@patch('Translators.Incident.pgquery.db_config', new={'pool_size': 5, 'max_overflow': 2, 'pool_timeout': 30, 'pool_recycle': 1800})
@patch('Translators.Incident.pgquery.db', new=None)
